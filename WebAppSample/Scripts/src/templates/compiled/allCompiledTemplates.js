...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<h2>Route Result</h2>\r\n<div class=\"row\">\r\n    <div class=\"col-xs-3\">\r\n        <p>Km total</p>\r\n        <h4>"
    ...
    + "</h4>\r\n    </div>\r\n    <div class=\"col-xs-3\">\r\n        <p>Cost total</p>\r\n        <h4>"
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.routeTotals)),stack1 == null || stack1 === false ? stack1 : stack1.totalCost)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</h4>\r\n    </div>\r\n</div>\r\n";
  return buffer;
  });
